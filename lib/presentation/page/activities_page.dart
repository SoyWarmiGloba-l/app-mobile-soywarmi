      ...
      if (state is GetActivityLoaded) {
        ...
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final images = ['https://source.unsplash.com/random/800x600/?activity', 'https://source.unsplash.com/random/800x600/?activity', 'https://source.unsplash.com/random/800x600/?activity'];
              return Container(
