...
Future<void> init() async {
  ...
  sl.registerFactory<NewsRemoteDataSource>(
      () => NewsRemoteDataSourceImplementation());

  sl.registerFactory<FaqsRemoteDataSource>(
      () => FaqsRemoteDataSourceImplementation());
  ...
  sl.registerFactory<NewsRepository>(
      () => NewsRepositoryImplementation(newsRemoteDataSource: sl()));

  sl.registerFactory<FaqsRepository>(
      () => FaqsRepositoryImplementation(faqsDataSource: sl()));

  sl.registerFactory<ActivityRepository>(
      () => ActivityRepositoryImplementation(activityDataSource: sl()));
  ...
  sl.registerFactory<GetNewsUseCase>(
      () => GetNewsUseCase(newsRepository: sl()));

  sl.registerFactory<GetFaqsUseCase>(
      () => GetFaqsUseCase(faqsRepository: sl()));

  sl.registerFactory<GetActivityUseCase>(
      () => GetActivityUseCase(activityRepository: sl()));
